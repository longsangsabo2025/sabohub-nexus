...
if (!connectionString) {
  ...
  console.log('Please ensure you have a .env file with the database connection string.');
  process.exit(1);
}
...
async function runMigration() {
  try {
    ...
    const sqlFilePath = path.join(__dirname, 'database', 'migrations', '006_add_payroll_fields.sql');
    ...
    console.log('Executing SQL migration to add payroll fields...');
